...
def main():
    print("Starting identity manager tag-success test...")
    print("Tap the correct sticker within the tag timeout window.")
    ...
    try:
        ...
        tag_runtime.stop()
        db.cleanup()
        print("\nIdentity manager tag-success test completed.")
