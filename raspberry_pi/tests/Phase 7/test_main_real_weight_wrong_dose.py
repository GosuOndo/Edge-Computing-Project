...
def main():
    print("Starting main real-weight WRONG-DOSE workflow test...")
    ...
    print("- remove the WRONG number of pills, e.g. 1 pill")
    ...
    try:
        ...
        system.stop()
        print("Main real-weight WRONG-DOSE workflow test completed.")
